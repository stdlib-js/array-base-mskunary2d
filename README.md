...
```javascript
mskunary2d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-mskunary2d@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-mskunary2d@v0.2.2-umd/browser.js"></script>
```
